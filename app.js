...
function background(){
 document.getElementById("karta").style.backgroundImage = "url(https://wykop.pl/cdn/c3201142/comment_lCCETisKK5crkpfEFg8o8cnUaJGSSdWY.jpg)"
 ...
 document.getElementById("menu").style.backgroundColor = "rgb(56, 42, 42)"
  ...
  document.getElementById("karta").style.backgroundImage = "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMo2fPC1FD2Mn1wMIUsmfxayr1-nrKqdH7RQ&usqp=CAU)"
  document.getElementById("karta").style.transition = "0.1s"  
  document.getElementById("info").style.backgroundColor = "grey"
 document.getElementById("menu").style.backgroundColor = "lightgrey"
}
  function background2(){
   document.getElementById("karta").style.backgroundImage = "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2NVH8P-nREd5-tIuSXleL6UD-TpxcsM8xiQ&usqp=CAU)"
   document.getElementById("karta").style.transition = "0.1s"
